...
if __name__ == '__main__':
    ...
    hand_dataset = dataset.HandCropDataset(image_folder, pose_name, image_transforms, crop_size=48)
    # length = len(face_dataset)
    length = len(hand_dataset)
    ...
    for i in tqdm(range(length)):
        ...
        _, fake_hand, top, bottom, left, right, real_full, fake_full \
            = hand_dataset.get_full_sample(i)
